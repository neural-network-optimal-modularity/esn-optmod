...
if __name__ == '__main__':
    ...
    # for key, val in final_results['parameters']['parameters'].items():
    #     print(key, val)
    # sys.exit()
    ...
    # Contour plot
    prefix = "MC_N500_c1_e10_train1k_ws1.132_gain1.0_com10_mu_v_rsig_version2"#'MC_N500_c1_e10_train1k_gain1.0_ws1.132_mu-rsig'
    final_results = utilities.load_object('/home/nathaniel/workspace/function_of_modularity/' + prefix + '_final_results.pyobj')
    print(final_results['parameters'])
    listQ1_listQ2_listTrials_mc = np.array([[[k[2][0] for k in j] for j in i] for i in final_results['results']])
    ...
    plt.savefig("paper_mc_plots.svg", dpi=900)